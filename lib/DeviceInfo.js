...
exports.devType2Info = function (devID) {
	...
	if ((devID >= 0x7530) && (devID <= 0x7918)) {
		...
		switch (devID) {
			...
			// SCB1E uses SP4/SP4B JSON state/control, not SP2/SP3S.
			case 0xA56B:
			case 0x5115:
			case 0x6113: info.type = BroadlinkType.SCB1E; info.name = 'SCB1E'; break;
			...
			case 0x27c2: info.type = BroadlinkType.RM; info.name = 'RM Mini 3'; break;
			...
			case 0x5224: info.type = BroadlinkType.RM4mini; info.name = 'RM5 plus'; break;
			...
			case 0xAF8B: info.type = BroadlinkType.RM4Pro; info.name = 'RM Max'; break;
